...
const ProductDetailsPage = () => {
    return (
       <>
        <div className='bg-white text-black grid grid-cols-2 py-7'>
            <div>
                <Image src={"https://i.ibb.co.com/ZMP3Xpt/image-5.png"} height={500} width={400} alt='image' />
            </div>

            <div className='space-y-5'>
                <div className='space-y-4'>
                    <button className='btn bg-[#3a2960] text-white px-3 '>New Arrivals!</button>
                    <h3 className='text-2xl'>White Hoodie</h3>
                    {/*  ==================  rating ============ */}
